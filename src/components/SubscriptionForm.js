...
// //   updateSubscription,
// // } from "../slices/companyProductSubscriptionSlice";
// // import { createCompanyFeeStructure } from "../slices/companyFeeSlice";
...
// //     dispatch(getCompanies());
// //     dispatch(getProducts());
// //     dispatch(getFeeStructuresByFeeType("Subscription"));
// //     if (subscription) {
// //       form.setFieldsValue({
// //         companyID: subscription.companyID,
// //         productID: subscription.productID,
// //         notifyBeforeXDays: subscription.notifyBeforeXDays,
// //         noOfUsers: subscription.noOfUsers,
// //         noOfDevice: subscription.noOfDevice,
// //         feeType: "Subscription",
// //       });
// //     } else {
// //       form.setFieldsValue({ feeType: "Subscription" });
// //     }
// //   }, [subscription, form, dispatch]);
...
// //         feeType: values.feeType,
// //         feeAmount: subscriptionFee,
// //       };

// //       let createdSubscription;
// //       if (subscription) {
// //         createdSubscription = await dispatch(
// //           updateSubscription({
// //             id: subscription.companyProductID,
// //             data: subscriptionData,
// //           })
...
// //       // Find the matching fee structure to get the FeeID
// //       const matchingFee = feeStructures.find(
// //         (fee) =>
// //           fee.feeType === "Subscription" &&
// //           fee.noOfUsers === values.noOfUsers &&
// //           fee.noOfDevice === values.noOfDevice
// //       );

// //       // Create the company fee structure
// //       if (createdSubscription && matchingFee) {
// //         const companyFeeData = {
// //           companyProductID: createdSubscription.companyProductID,
// //           feeID: matchingFee.feeID,
// //           paidAmount: 0,
// //           payableAmount: subscriptionFee,
// //           unpaidAmount: subscriptionFee,
// //           state: true,
// //         };
// //         await dispatch(createCompanyFeeStructure(companyFeeData));
// //       }
